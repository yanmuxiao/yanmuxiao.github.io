  ...
  $.fn.mdater = function(config) {
    ...
    var mdater = {
      ...
      afterShowPanel: function(mask, panel) {
        ...
        panel.delegates({
          '.change_month': function() {console.log(_this);
